...
ipnet <- function(address=NULL) {
        ...
        #Regular Expression when the user submits CIDR (address1 and first if statement) or IP and Subnet Mask (address2 and else if statement). If the input is wrong print it out.
        ...
        #Here to calculate the usable hosts we could also substract the prefix size from 32 and then result is the power that we need to raise 2 (e.g.,  for /24 -> 32-24= 8, and then we raise 2 to the power of 8 = 256 hosts) 
...
#this function transforms decimal to binary format (representation)
...
#function to print IPv4 related information based on the given CIDR or Subnet mask
